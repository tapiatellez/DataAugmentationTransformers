...
output_file = open("results_spam.txt", "w+")
output_string = ""
for i in range(5):
    ...
    for path in path_list:
        ...
        output_string = output_string + path + ": " + "RNN: " + str(accr[1]) + ", " + "CNN: " + str(score[1]) + "\n"
    results_dictionary["Run: " + str(i+1)] = file_results_dictionary
print("Results dictionary: ")
print(results_dictionary)
#   Divide them by five
output_string = output_string + "Average Results: " + "\n"
final_dictionary = {}
for path, vector in average_dictionary.items():
    final_dictionary[path] = np.array(vector)/5
    output_string = output_string + path + ": " + "RNN: " + str(vector[0]/5) + "CNN: " + str(vector[1]/5) + "\n"
