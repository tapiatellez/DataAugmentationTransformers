...
def createDataAugmentationDictionary(sentences, labels):
    ...
    for sentence, label in zip(sentences, labels):
        ...
        if len(tokenized_sentence) > 1:
            ...
            predicted_sentences_dict[str(label) + "\t" + sentence] = sentences_list
        else:
            predicted_sentences_dict[str(label) + "\t" + sentence] = None
...
augmented_file = open("augmented_data_500_One.txt", "w+")
augmented_string = ""
